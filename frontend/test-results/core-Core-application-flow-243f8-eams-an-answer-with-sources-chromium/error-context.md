...
- Name: core.spec.ts >> Core application flows >> grounded question streams an answer with sources
- Location: tests\e2e\core.spec.ts:36:7
...
Locator: getByText('Sources:')
Expected: visible
Timeout: 10000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" getByText('Sources:') with timeout 10000ms
  - waiting for getByText('Sources:')

```

```yaml
- complementary "Session sidebar":
  - heading "Lenny Growth" [level=1]
...
- banner:
  ...
  - text: 2 messages
- paragraph: What does Elena Verna say about product-led sales?
- paragraph: 6:47:42 PM
- text: U
- img
- paragraph: Elena Verna recommends starting with self-serve onboarding before sales.
- paragraph: "Grounded in:"
- button "Elena Verna on PLG"
- paragraph: 6:47:43 PM
- textbox "Ask about product, growth, or create artifacts..."
- button "Send message" [disabled]:
  - img
- text: Enter Send • Shift+Enter New line Local Ollama
- alert
```
