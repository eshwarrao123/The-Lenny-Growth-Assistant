...
- Name: copy-download.spec.ts >> Copy and download controls >> markdown artifact downloads as .md with correct content
- Location: tests\e2e\copy-download.spec.ts:54:7
