...
- Name: accessibility.spec.ts >> Accessibility >> HTML artifact iframe has a title
- Location: tests\e2e\accessibility.spec.ts:32:7
...
Locator: getByRole('region', { name: 'Artifact viewer' }).locator('iframe')
Expected: visible
Timeout: 10000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" getByRole('region', { name: 'Artifact viewer' }).locator('iframe') with timeout 10000ms
  - waiting for getByRole('region', { name: 'Artifact viewer' }).locator('iframe')
